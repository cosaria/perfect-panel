...
export async function queryRevenueStatistics(options?: Record<string, unknown>) {
...
export async function queryServerTotalData(options?: Record<string, unknown>) {
...
export async function queryTicketWaitReply(options?: Record<string, unknown>) {
...
export async function queryUserStatistics(options?: Record<string, unknown>) {
