...
interface AnnouncementFormProps<T extends AnnouncementFormValues> {
...
export default function AnnouncementForm<T extends AnnouncementFormValues>({
  onSubmit,
  initialValues,
  loading,
  trigger,
  ...
  async function handleSubmit(data: AnnouncementFormValues) {
