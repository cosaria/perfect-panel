...
type DnsArrayInputValue = {
  proto?: string;
  address?: string;
  domains?: string | string[];
};
type OutboundArrayInputValue = {
  name?: string;
  protocol?: string;
  address?: string;
  port?: number;
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <ArrayInput
                            ...
                            onChange={(values) => {
                              const converted = values.map((item: DnsArrayInputValue) => ({
                                proto: item.proto,
                        ...
                        <FormItem>
                          <FormControl>
                            <ArrayInput
                              ...
                              onChange={(values) => {
                                const converted = values.map((item: OutboundArrayInputValue) => ({
                                  name: item.name,
