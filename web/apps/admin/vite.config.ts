  ...
  resolve: {
    alias: [
      ...
      },
      {
        ...
        replacement: path.resolve(adminRoot, "src/compat/next-image.tsx"),
      },
      {
        find: "next/image",
        replacement: path.resolve(adminRoot, "src/compat/next-image.tsx"),
      ...
      {
        find: "next/link",
        replacement: path.resolve(adminRoot, "src/compat/next-link.tsx"),
      },
      {
        find: "next/navigation",
        replacement: path.resolve(adminRoot, "src/compat/next-navigation.ts"),
      },
    ],
  },
  server: {
