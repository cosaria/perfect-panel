...
interface CouponFormProps<T extends CouponFormValues> {
...
export default function CouponForm<T extends CouponFormValues>({
  onSubmit,
  initialValues,
  loading,
  trigger,
  ...
  async function handleSubmit(data: CouponFormValues) {
