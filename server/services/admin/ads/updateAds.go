...
func UpdateAdsHandler(deps Deps) func(context.Context, *UpdateAdsInput) (*struct{}, error) {
	return func(ctx context.Context, input *UpdateAdsInput) (*struct{}, error) {
		l := NewUpdateAdsLogic(ctx, deps)
...
// Update Ads
func NewUpdateAdsLogic(ctx context.Context, deps Deps) *UpdateAdsLogic {
...
func (l *UpdateAdsLogic) UpdateAds(req *types.UpdateAdsRequest) error {
	...
	if err := l.deps.AdsModel.Update(l.ctx, data); err != nil {
